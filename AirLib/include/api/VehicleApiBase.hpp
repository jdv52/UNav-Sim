...
*/
    ...
    public:
        ...
        */
        ...
        // Sonar APIs
        virtual const SonarData& getSonarData(const std::string& sonar_name) const
        {
            auto* sonar = static_cast<const SonarBase*>(findSensorByName(sonar_name, SensorBase::SensorType::Sonar));
            if (sonar == nullptr)
